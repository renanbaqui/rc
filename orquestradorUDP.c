...
int main(int argc, char *argv[])
{
    ...
    const char *message = "shutdown do orquestrador"; //"mensagem de multicast do orquestrador";
    ...
    // loop de recebimento limitado a 'j' vezes
    while (j) {
    ...
    for (i=0;i<1;i++) {
    // envia de volta as mensagens do servidor e cliente
      char ch = 0;
      int nbytes = sendto(  // retirar int?
          fd,
          mensagem1,
          strlen(mensagem1),
          0,
